...
const validationSchema = Yup.object().shape({
  ...
  emotion1: Yup.object()
    .shape({ id: Yup.string(), key: Yup.string(), primaryText: Yup.string() })
    .required('Required'),
        ...
        <Grid gutters="md">
          <Cell columns={atWidth({ sm: 12, lg: 7 })}>
            <H3 size="H4">
              ...
              <Subheading>Use the following form to generate a custom purpose statement.</Subheading>
            </H3>
            <Separator size="xs" />
            ...
            <Grid guttersY="none">
              ...
              />
              <Row>
                <Button color="gray" type="submit" emphasis="high" disabled={!isValid}>
                  Submit
                </Button>
                <Button
                  type="reset"
...
const PurposeStatement = ({
  ...
  return (
    <Card margins="sparse" edges="border" backgroundColor={colors.gray02}>
      <Separator growY />
      <H3 size="H4" supplementary centered>
        {purposeStatement}
      </H3>
      <Separator growY />
    </Card>
