[![Build Status](https://travis-ci.com/fs-webdev/my-world.svg?branch=master)](https://travis-ci.com/fs-webdev/my-world)
...
1. Clone this repo to your machine  
  `git clone https://github.com/fs-webdev/my-world.git`
2. Run `npm install`
